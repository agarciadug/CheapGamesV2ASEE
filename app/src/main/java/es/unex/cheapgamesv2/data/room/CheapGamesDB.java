...
@Database(entities = {Usuario.class, ListaSeguimiento.class, Videogame.class, VideogameDeal.class, VideogameBest.class}, version = 13)
public abstract class CheapGamesDB extends RoomDatabase {
    ...
    public abstract VideogameBestDao videogameBestDao();
}
