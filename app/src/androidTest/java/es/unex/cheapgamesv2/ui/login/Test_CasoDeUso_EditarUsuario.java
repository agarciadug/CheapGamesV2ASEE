...
public class Test_CasoDeUso_EditarUsuario {
    ...
    @Test
    public void test_CasoDeUso_EditarUsuario() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.login), withText("Iniciar Sesión"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.ajustesFragment), withContentDescription("Usuario"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.cambiarNomUsuario), withText("test"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.cambiarEmail), withText("tt@tt.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.frame_container),
                                        0),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.cambiarEmail), withText("tt@tt.com"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("tt@test.com"));

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.cambiarEmail), withText("tt@test.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.frame_container),
                                        0),
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.b_aplicarCambios), withText("Aplicar cambios"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.frame_container),
                                        0),
